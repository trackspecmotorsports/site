 ...
 *
 */
class Meigee_ThemeOptionsIndigo_Model_Activation extends Mage_Core_Model_Abstract
{
    protected $settings;
    private $_file = '/app/code/local/Meigee/ThemeOptionsIndigo/etc/import/cms.xml';
