 ...
 */
class Meigee_ThemeOptionsIndigo_Block_Adminhtml_Restore_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('setup_package', 'checkbox', array(
            'label' => Mage::helper('ThemeOptionsIndigo')->__('Deactivate Theme'),
            'required' => false,
            'name' => 'setup_package',
            'value' => 1,
        ...
        $fieldset->addField('setup_pages', 'checkbox', array(
            'label' => Mage::helper('ThemeOptionsIndigo')->__('Restore Cms Pages'),
            'required' => false,
            'name' => 'setup_pages',
            'value' => 1,
            'after_element_html' => 'Check to restore all demo pages',                
            'note' => Mage::helper('ThemeOptionsIndigo')->__('All changes you made in these pages will be lost'),

        ))->setIsChecked(1);

        $fieldset->addField('setup_blocks', 'checkbox', array(
            'label' => Mage::helper('ThemeOptionsIndigo')->__('Restore Cms Blocks'),
            'required' => false,
            'name' => 'setup_blocks',
            'value' => 1,
        ...
        $fieldset->addField('clear_scope', 'checkbox', array(
                'name'  => 'clear_scope',
                'value' => 1,
                'label' => Mage::helper('ThemeOptionsIndigo')->__('Clear Configuration'),
                'title' => Mage::helper('ThemeOptionsIndigo')->__('Clear Configuration'),
